...
description: Reference guide for authoring supertinker plugins — workflows, providers, hooks, and storage adapters. Use this skill whenever the user wants to create, extend, or understand how to build a new workflow, provider, hook, or storage adapter for supertinker.
---

# supertinker Plugin Authoring Reference

supertinker is extended through four plugin types. All are TypeScript (or JS) files dropped into a search-path directory — no build step, no registration.
